...
from pandas_datareader import get_iex_data_tiingo
...
def repo_path(repo, *path):
    ...
    return os.path.join(repo.girdir, *path)
...
argsp.add_argument("-w",
                    dest="write",
                    action="store_true",
                    help="Actually write the object into the databse")
...
def tree_parse_one(raw, start=0):
    ...
    # Find the NULL terminator or the path
    y = raw.find(b'\x00', x)
    # and read the path
    path = raw[x+1:y]
